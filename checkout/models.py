...
class Order(models.Model):
    ...
    date = models.DateTimeField(
        auto_now_add=True)  # sets date when order is created

    # last three fields are calculated
    # using a custom model method whenever order is saved
    ...
    def save(self, *args, **kwargs):
        """
        Override the default save method to set the order number if it hasnt been saved already
        """
